...
CREATE DATABASE IF NOT EXISTS `database_characters` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE IF NOT EXISTS `account_buff` (
  ...
  `buff` smallint(6) NOT NULL,
  `effect_1` tinyint(4) DEFAULT NULL,
  `value_1` int(11) DEFAULT NULL,
  `effect_2` tinyint(4) DEFAULT NULL,
  `value_2` int(11) DEFAULT NULL,
  `effect_3` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `account_data` (
  ...
  `expanded_warehouse` tinyint(4) DEFAULT NULL,
  `expanded_warehouse_time` bigint(20) DEFAULT NULL,
  `special_character` smallint(6) DEFAULT NULL,
  ...
  `current_diskserial` int(11) DEFAULT NULL,
  `current_server` smallint(6) DEFAULT NULL,
  `cash_shop_discount_wc` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `castle_siege_data` (
  ...
  `tax_chaos` tinyint(4) DEFAULT NULL,
  `tax_store` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `castle_siege_npc` (
  `npc` smallint(6) NOT NULL,
  `id` tinyint(4) DEFAULT NULL,
  `defense_level` tinyint(4) DEFAULT NULL,
  `regen_level` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `character_gameoption` (
  `char_id` int(11) NOT NULL,
  `game_option` tinyint(4) DEFAULT NULL,
  `chat_window` tinyint(4) DEFAULT NULL,
  `q_key` tinyint(4) DEFAULT NULL,
  `w_key` tinyint(4) DEFAULT NULL,
  `e_key` tinyint(4) DEFAULT NULL,
  `r_key` tinyint(4) DEFAULT NULL,
  `qwer_level` int(11) DEFAULT NULL,
  `skill_bind_0` smallint(6) DEFAULT NULL,
  `skill_bind_1` smallint(6) DEFAULT NULL,
  `skill_bind_2` smallint(6) DEFAULT NULL,
  `skill_bind_3` smallint(6) DEFAULT NULL,
  `skill_bind_4` smallint(6) DEFAULT NULL,
  `skill_bind_5` smallint(6) DEFAULT NULL,
  `skill_bind_6` smallint(6) DEFAULT NULL,
  `skill_bind_7` smallint(6) DEFAULT NULL,
  `skill_bind_8` smallint(6) DEFAULT NULL,
  `skill_bind_9` smallint(6) DEFAULT NULL,
  `extra_data` bigint(20) DEFAULT NULL,
  `change_skin` tinyint(4) DEFAULT NULL,
  `additional_options` smallint(6) DEFAULT NULL,
  `button_bind_1` tinyint(4) DEFAULT NULL,
  `button_bind_2` tinyint(4) DEFAULT NULL,
  `button_bind_3` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `character_helper` (
  `char_id` int(11) NOT NULL,
  `option_flag_1` int(11) DEFAULT NULL,
  `option_flag_2` int(11) DEFAULT NULL,
  `item_pick_flag` tinyint(4) DEFAULT NULL,
  `hunting_range` tinyint(4) DEFAULT NULL,
  `item_pick_range` tinyint(4) DEFAULT NULL,
  `distance` smallint(6) DEFAULT NULL,
  `attack_skill_1` smallint(6) DEFAULT NULL,
  `attack_sec_skill_1` smallint(6) DEFAULT NULL,
  `attack_sec_skill_2` smallint(6) DEFAULT NULL,
  `attack_sec_delay_1` smallint(6) DEFAULT NULL,
  `attack_sec_delay_2` smallint(6) DEFAULT NULL,
  `buff_skill_1` smallint(6) DEFAULT NULL,
  `buff_skill_2` smallint(6) DEFAULT NULL,
  `buff_skill_3` smallint(6) DEFAULT NULL,
  `time_space_casting` smallint(6) DEFAULT NULL,
  `percent_autopot` tinyint(4) DEFAULT NULL,
  `percent_autoheal` tinyint(4) DEFAULT NULL,
  `percent_partyheal` tinyint(4) DEFAULT NULL,
  `percent_drainlife` tinyint(4) DEFAULT NULL,
  `item_list` smallint(6) DEFAULT NULL,
  `buff_item_1` smallint(6) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `character_hunting_record` (
  ...
  `elemental_damage` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `character_info` (
  ...
  `post_day` tinyint(4) DEFAULT NULL,
  `post_month` tinyint(4) DEFAULT NULL,
  `ruud_money` int(11) DEFAULT NULL,
  `hunting_log_visible` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `character_labyrinth_zone` (
  ...
  `subidx` tinyint(4) NOT NULL,
  `mission_id_1` tinyint(4) DEFAULT NULL,
  `mission_id_2` tinyint(4) DEFAULT NULL,
  `mission_id_3` tinyint(4) DEFAULT NULL,
  `mission_id_4` tinyint(4) DEFAULT NULL,
  `mission_id_5` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `character_mu_roomy` (
  `char_id` int(11) NOT NULL,
  `playing` tinyint(4) DEFAULT NULL,
  `type` tinyint(4) DEFAULT NULL,
  `score` smallint(6) DEFAULT NULL,
  `card_count` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `character_numeric_baseball` (
  ...
  `state` tinyint(4) DEFAULT NULL,
  `score` int(11) DEFAULT NULL,
  `number_1` tinyint(4) DEFAULT NULL,
  `number_2` tinyint(4) DEFAULT NULL,
  `number_3` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `event_arka_war_kill` (
  ...
  `char_rank` tinyint(4) DEFAULT NULL,
  ...
  `killer_rank` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `event_labyrinth_league` (
  ...
  `char_id` int(11) NOT NULL,
  `char_name` varchar(255) DEFAULT NULL,
  `char_class` tinyint(4) DEFAULT NULL,
  `score` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `guild_matching` (
  ...
  `interest_type` tinyint(4) DEFAULT NULL,
  `level_range` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `item_data` (
  ...
  `luck` tinyint(4) DEFAULT NULL,
  `option` tinyint(4) DEFAULT NULL,
  `excellent` tinyint(4) DEFAULT NULL,
  `ancient` tinyint(4) DEFAULT NULL,
  `option_380` tinyint(4) DEFAULT NULL,
  `harmony` tinyint(4) DEFAULT NULL,
  `socket_1` smallint(6) DEFAULT NULL,
  `socket_2` smallint(6) DEFAULT NULL,
  `socket_3` smallint(6) DEFAULT NULL,
  `socket_4` smallint(6) DEFAULT NULL,
  `socket_5` smallint(6) DEFAULT NULL,
  ...
  `personal_store_job` smallint(6) DEFAULT NULL,
  `personal_store_jos` smallint(6) DEFAULT NULL,
  `personal_store_joc` smallint(6) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `item_pentagram_data` (
  ...
  `item_index` smallint(6) DEFAULT NULL,
  `item_level` tinyint(4) DEFAULT NULL,
  `option_index_rank_1` tinyint(4) DEFAULT NULL,
  `option_level_rank_1` tinyint(4) DEFAULT NULL,
  `option_index_rank_2` tinyint(4) DEFAULT NULL,
  `option_level_rank_2` tinyint(4) DEFAULT NULL,
  `option_index_rank_3` tinyint(4) DEFAULT NULL,
  `option_level_rank_3` tinyint(4) DEFAULT NULL,
  `option_index_rank_4` tinyint(4) DEFAULT NULL,
  `option_level_rank_4` tinyint(4) DEFAULT NULL,
  `option_index_rank_5` tinyint(4) DEFAULT NULL,
  `option_level_rank_5` tinyint(4) DEFAULT NULL,
  `serial_server` smallint(6) DEFAULT NULL,
  `serial` int(11) DEFAULT NULL,
  `flags` int(11) DEFAULT NULL,
  `data_1` int(11) DEFAULT NULL,
  `data_2` int(11) DEFAULT NULL,
